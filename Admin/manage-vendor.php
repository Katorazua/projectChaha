...
// fetch users from database but not Super admin
  ...
  $query = "SELECT * FROM vendor WHERE admin_id=$admin_id ORDER BY RAND()";
              ...
              <table class="table datatable">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="edit-vendor.php?id=<?= $user['id']?>" class="btn sm"><i class="bi bi-pencil-square"></i></a>
                      <a href="delete-vendor.php?id=<?= $user['id']?>" class="btn sm danger"><i class="bi bi-trash"></i></a>
                    </td>
                  </tr>
