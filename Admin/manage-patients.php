...
$user_query = "SELECT * FROM patients WHERE admin_id=$admin_id ORDER BY pat_fname ASC";
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h1 class="text-center card-title">All Patients</h1>
              <hr>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <!-- <a href="delete-patient.php?id=<?= $user['id']?>" class="btn sm danger"><i class="bi bi-trash"></i></a> -->
                    </td>
                  </tr>
