...
// fetch users from database but not Super admin
  ...
  $query = "SELECT * FROM pharmaceuticals_categories WHERE admin_id=$admin_id ORDER BY RAND()";
              ...
              <table class="table datatable">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="view-pharm-category.php?id=<?= $user['id']?>" class="btn sm view"><i class="bi bi-eye"></i></a>
                      <a href="edit-pharm-category.php?id=<?= $user['id']?>" class="btn sm"><i class="bi bi-pencil-square"></i></a>
                      <a href="delete-pharm-category.php?id=<?= $user['id']?>" class="btn sm danger"><i class="bi bi-trash"></i></a>
                    </td>
                  </tr>
