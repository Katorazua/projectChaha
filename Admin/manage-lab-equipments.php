...
// fetch users from database but not Super admin
  ...
  $query = "SELECT * FROM equipments WHERE admin_id=$admin_id ORDER BY RAND()";
              ...
              <table class="table datatable">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="view-lab-equipment.php?id=<?= $user['id']?>" class="btn sm view"><i class="bi bi-eye"></i>View</a>
                      <a href="edit-lab-equipment.php?id=<?= $user['id']?>" class="btn sm"><i class="bi bi-pencil-square"></i>Update</a>
                      <!-- <a href="delete-lab-equipment.php?id=<?= $user['id']?>" class="btn sm danger"><i class="bi bi-trash"></i></a> -->
                    </td>
                  </tr>
