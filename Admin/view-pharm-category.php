    ...
    <section class="section profile">
      <div class="row">
        <div class="col-xl-4">
          ...
          <div class="card">
          <img src="<?=ROOT_URL?>img/pharm.webp" >           
          </div>
            ...
            <div class="card-body pt-3">
              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                  ...
                  <p class="small fst-italic"><?=$user['pharm_cat_desc'] ?></p>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Name</div>
                    <div class="col-lg-9 col-md-8"><?=$user['pharm_cat_name'] ?></div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Vendor</div>
                    <div class="col-lg-9 col-md-8"><?=$user['pharm_cat_vendor'] ?></div>
                  </div>
