...
if (isset($_GET['id'])) {
    ...
    $query = "SELECT * FROM employee_transfer WHERE id = $id";
    ...
    if (mysqli_num_rows($result) == 1) {
        ...
        if ($avatar_path) {
            ...
            $delete_post_query = "DELETE FROM employee_transfer WHERE id=$id LIMIT 1";
...
header('location:' .ROOT_URL. 'alphaMyAdmin/history.php');
die();