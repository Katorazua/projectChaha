        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <!-- Multi Columns Form -->
              <form class="row g-3" action="add-event-logic.php" method="POST" enctype="multipart/form-data">
                ...
                <tbody>
                  <?php while ($post = mysqli_fetch_assoc($posts)) : ?>
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="edit-event.php?id=<?= $post['id']?>" class="btn sm"><i class="bi bi-pencil-square"></i></a>
                        <a href="delete-event.php?id=<?= $post['id']?>" class="btn sm danger"><i class="bi bi-trash"></i></a>
                      </td>
                    </tr>
