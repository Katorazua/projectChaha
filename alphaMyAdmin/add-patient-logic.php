...
if (isset($_POST['submit'])) {
  ...
  if (!$firstname || !$lastname || !$dob || !$age || !$email || !$gender) {
      $_SESSION['add-user'] = "please enter patient's requirement";
  }  else {
  ...
  if (isset($_SESSION['add-user'])) {
    ...
    header('location:' . ROOT_URL. 'alphaMyAdmin/add-patient.php');
    die();
  } else {
    ...
    if (!mysqli_errno($connection)) {
        ...
        header('location:' . ROOT_URL . 'alphaMyAdmin/manage-patients.php');
        die();
    }
  } 
}else {
