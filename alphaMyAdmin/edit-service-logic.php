...
if (isset($_POST['submit'])) {
    ...
    //validate form data
    if (!$title) {
       $_SESSION['edit-service'] = "Couldn't update title. Invalid form data on title.";  
    } elseif (!$thumbnail['name']) {
        $_SESSION['edit-service'] = "Couldn't update thumbnail. Invalid file type.";
    } elseif (!$prices) {
        $_SESSION['edit-service'] = "Couldn't update price. Invalid form data ";
    } else{
    ...
    if (isset($_SESSION['edit-service'])) {
       ...
       header('location:'.ROOT_URL. 'alphaMyAdmin/manage-services.php');
        die();
    } else {
