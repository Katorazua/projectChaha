    ...
    <section class="section">
      <div class="card">
        <div class="card-body">
          ...
          <?php endif ?>
          <!-- Multi Columns Form -->
          <form action="add-doctor-logic.php" method="post" enctype="multipart/form-data" class="row g-3">
            <div class="col-md-6">
            ...
            <div class="col-md-6">
              ...
              ?>
              <input type="text" name="doc_number" value="AHMS/DOC/<?= $doc_number?>" class="form-control" id="inputName5" placeholder="Doctor's number">
            </div>
            <div class="col-md-6">
            ...
            <div class="col-md-6">
              ...
              <select id="inputState" name="role" class="form-select">
                ...
                <option value="AlphaCons">Consultant</option>
                <!-- <option value="Residence_Doctor">Residence Doctor</option> -->
              </select>
            </div>            
