...
// fetch users from database but not Super admin
  ...
  $query = "SELECT * FROM payrolls WHERE hps = 'Alpha' ORDER BY RAND()";
                ...
                <tbody>
                  <?php while ($user = mysqli_fetch_assoc($users)) : ?>
                    <tr>
                        ...
                        <td><?= $user['pay_acc_number'] ?></td>
                        <td><?= $user['status'] ?></td>
                        <td><?= $user['pay_date_generated'] ?></td>
                        <td>
                            <a href="edit-payroll.php?id=<?= $user['pay_id']?>" class="btn sm"><i class="bi bi-pencil-square"></i></a>
                            <a href="delete-payroll.php?id=<?= $user['pay_id']?>" class="btn sm danger"><i class="bi bi-trash"></i></a>
                        </td>
                    </tr>
