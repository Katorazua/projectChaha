<?php 
  ...
  $query = "SELECT * FROM patient_assign ORDER BY RAND()";
  ...
  <main id="main" class="main">
   ...
   <?php elseif(isset($_SESSION['delete-user-success'])) :  // show if delete-user was successful ?>
              ...
              <table class="table datatable">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><?= $user['status'] ?></td>
                    <td>
                      <a href="<?= ROOT_URL ?>superAdmin/edit-assign-patient.php?id=<?= $user['id']?>" class="btn sm"><i class="bi bi-pencil-square"></i></a>
                      <a href="<?= ROOT_URL ?>superAdmin/delete-assign-patient.php?id=<?= $user['id']?>" class="btn sm danger"><i class="bi bi-trash"></i></a>
                    </td>
                  </tr>
    ...
    <?php
      ...
      $query = "SELECT * FROM patient_transfer ORDER BY RAND()";
      $users = mysqli_query($connection, $query);
      $cnt = 1;
    ?>
              ...
              <table class="table datatable">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                     <a href="<?= ROOT_URL ?>superAdmin/delete-patient-history.php?id=<?= $user['id']?>" class="btn sm danger"><i class="bi bi-trash"></i></a>
                    </td>
                  </tr>
                  <?php $cnt=$cnt+1; endwhile ?> 
                  </tbody>
        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <table class="table datatable">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><?= $user['status'] ?></td>
                    <td>
                      <a href="<?= ROOT_URL ?>superAdmin/edit-employee.php?id=<?= $user['id']?>" class="btn sm"><i class="bi bi-pencil-square"></i>Update</a>
                      <a href="<?= ROOT_URL ?>superAdmin/delete-employee.php?id=<?= $user['id']?>" class="btn sm danger"><i class="bi bi-trash"></i>Delete</a>
                    </td>
                  </tr>
                  <?php $cnt=$cnt+1; endwhile ?> 
                  </tbody>
              ...
              <?php else : ?>
                <div class="alert_message error text-center"><?= "No Employees List found" ?></div>
              <?php endif ?>
              <!-- End Table with stripped rows -->
    ...
    // fetch users from database but not Super admin
  $admin_id = $_SESSION['user-id'];
  $query = "SELECT * FROM doc_transfer ORDER BY RAND()";
  $users = mysqli_query($connection, $query);
  $cnt = 1;
 ...
 ?>
    ...
    <section class="section">   
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h1 class="text-center card-title">Doctors Transfer History</h1>
              <hr>
              <!-- Table with stripped rows -->
              <?php if (mysqli_num_rows($users) > 0) : ?>
              <table class="table datatable">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><?= $user['ref_hospital'] ?></td>
                    <td><?= $user['status'] ?></td>
                    <td><?= $user['date_transfer'] ?></td>
                    <td>
                     <a href="<?= ROOT_URL ?>superAdmin/delete-doctor-history.php?id=<?= $user['id']?>" class="btn sm danger"><i class="bi bi-trash"></i></a>
                    </td>
                  </tr>
                  <?php $cnt=$cnt+1; endwhile ?> 
                  </tbody>
  ...
  // fetch users from database but not Super admin
  $admin_id = $_SESSION['user-id'];
  $query = "SELECT * FROM employee_transfer ORDER BY RAND()";
  $users = mysqli_query($connection, $query);
  $cnt = 1;
 ?>
    ...
    <section class="section"> 
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h1 class="text-center card-title">Employees Transfer History</h1>
              <hr>
              <!-- Table with stripped rows -->
              <?php if (mysqli_num_rows($users) > 0) : ?>
              <table class="table datatable">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><?= $user['email'] ?></td>
                    <td><?= $user['phone'] ?></td>
                    <td><?= $user['ref_company'] ?></td>
                    <td><?= $user['status'] ?></td>
                    <td><?= $user['transfer_date'] ?></td>
                    <td>
                     <a href="<?= ROOT_URL ?>superAdmin/delete-employee-history.php?id=<?= $user['id']?>" class="btn sm danger"><i class="bi bi-trash"></i></a>
                    </td>
                  </tr>
                  <?php $cnt=$cnt+1; endwhile ?> 
                  </tbody>
