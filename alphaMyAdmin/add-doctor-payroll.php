...
if (isset($_POST['submit'])) {
    ...
    if (isset($_SESSION['add-user'])) {
      ...
      $status = "NotPaid";
      $hps = "Alpha";
      $user_query = " INSERT INTO payrolls (admin_id, pay_doc_name, pay_descr, pay_doc_email, pay_doc_number, pay_acc_number, pay_emp_salary, pay_number, hps, status, rid) VALUES('$admin_id', '$pay_doc_name', '$pay_descr', '$pay_doc_email', '$pay_doc_number', '$pay_acc_number', '$pay_emp_salary', '$pay_number', '$hps', '$status', '$rid')";
