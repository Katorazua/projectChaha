...
if (isset($_POST['submit'])) {
  ...
  if (isset($_SESSION['add-user'])) {
    ...
    $user_query = " INSERT INTO doctors (firstname, lastname, email, doc_number, password, department, status, hps, role) VALUES('$firstname', '$lastname', '$email', '$doc_number', '$password', '$dept', '$status', '$hps', '$role')";
