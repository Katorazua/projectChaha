...
if (isset($_POST['submit'])) {
  ...
  if (!$firstname || !$lastname || !$doc_number || !$email) {
      $_SESSION['add-user'] = "please enter all valied fields";
  ...
  if (isset($_SESSION['add-user'])) {
    ...
    header('location:' . ROOT_URL. 'alphaMyAdmin/add-doctor.php');
    die();
  } else {
    ...
    $user_query = " INSERT INTO doctors (firstname, lastname, email, doc_number, password, department, status, role) VALUES('$firstname', '$lastname', '$email', '$doc_number', '$hashed_password', '$dept', '$status', '$role')";
    ...
    if (!mysqli_errno($connection)) {
        ...
        header('location:' . ROOT_URL . 'alphaMyAdmin/manage-doctors.php');
        die();
    }
  } 
}else {
