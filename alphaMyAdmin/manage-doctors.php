              ...
              <table class="table datatable">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><?= $user['status'] ?></td>
                    <td>
                      <a href="doctors-profile.php?id=<?= $user['id']?>" class="btn sm view"><i class="bi bi-eye"></i></a>
                      <a href="edit-doctor.php?id=<?= $user['id']?>" class="btn sm"><i class="bi bi-pencil-square"></i></a>
                      <a href="delete-doctor.php?id=<?= $user['id']?>" class="btn sm danger"><i class="bi bi-trash"></i></a>
                    </td>
                  </tr>
