...
$user_query = "SELECT * FROM laboratory ORDER BY date_time DESC";
              ...
              <table class="table datatable">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="<?= ROOT_URL ?>superAdmin/view-patient-lab-report.php?id=<?= $user['id']?>" class="btn sm view"><i class="bi bi-pencil-square"></i>View Report</a>
                    </td>
                  </tr>
