        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <!-- Multi Columns Form -->
              <form class="row g-3"  action="<?= ROOT_URL ?>superAdmin/add-category-logic.php" method="post" enctype="multipart/form-data"> 
    ...
    <section class="section">
      ...
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h1 class="text-center card-title">All Categories Datatables</h1>
              <hr>
              ...
              <table class="table datatable">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><a href="<?= ROOT_URL ?>superAdmin/edit-category.php?id=<?= $category['id']?>" class="btn sm"><i class="bi bi-pencil-square"></i></a>
                    <a href="<?= ROOT_URL ?>superAdmin/delete-category.php?id=<?= $category['id']?>" class="btn sm danger"><i class="bi bi-trash"></i></a></td>
                  </tr>
