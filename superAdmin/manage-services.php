...
?>
  ...
  <main id="main" class="main">
        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <?php endif ?>
              <!-- Multi Columns Form -->
              <form class="row g-3" action="<?=ROOT_URL?>superAdmin/add-service-logic.php" method="Post" enctype="multipart/form-data">
    ...
    <?php 
      ...
      $query = "SELECT * FROM patients  ORDER BY title";
              ...
              <table class="table datatable">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><?= $post['prices'] ?></td>
                    <td>
                      <a href="<?= ROOT_URL ?>superAdmin/edit-service.php?id=<?= $post['id']?>" class="btn sm"><i class="bi bi-pencil-square"></i></a>
                      <a href="<?= ROOT_URL ?>superAdmin/delete-service.php?id=<?= $post['id']?>" class="btn sm danger"><i class="bi bi-trash"></i></a>
                  </td>
                  </tr>
