        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <!-- Multi Columns Form -->
              <form class="row g-3" action="<?= ROOT_URL ?>superAdmin/add-intro-logic.php" method="POST" enctype="multipart/form-data">
                ...
                <tbody>
                  <?php while ($user = mysqli_fetch_assoc($users)) : ?>
                    <tr>
                      ...
                      <td>
                        <a href="<?= ROOT_URL ?>superAdmin/view-session.php?id=<?= $user['id']?>" class="btn sm view"><i class="bi bi-play"></i></a>
                        <a href="<?= ROOT_URL ?>superAdmin/edit-intro.php?id=<?= $user['id']?>" class="btn sm"><i class="bi bi-pencil-square"></i></a>
                        <a href="<?= ROOT_URL ?>superAdmin/delete-intro.php?id=<?= $user['id']?>" class="btn sm danger"><i class="bi bi-trash"></i></a>
                      </td>
                    </tr>
