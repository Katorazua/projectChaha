...
$s_number = filter_var($_POST['s_number'], FILTER_SANITIZE_FULL_SPECIAL_CHARS);
    ...
    if(!$s_pat_status) {
      ...
      if (mysqli_num_rows($user_check_result) > 0) {
        ...
        $user_query = " INSERT INTO surgery (admin_id, s_pat_name, s_pat_ailment, s_number, s_pat_number, s_pat_status, s_doc) VALUES('$admin_id', '$s_pat_name', '$s_pat_ailment', '$s_number', '$s_pat_number', '$s_pat_status', '$s_doc')";
