        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <a href="<?= ROOT_URL ?>superAdmin/view-assign-patient.php" class="btn sm"><i class="bi bi-eye"></i>View History</a>
              <hr>
              ...
              <table class="table datatable">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><?= $user['status'] ?></td>
                    <td>
                      <a href="<?= ROOT_URL ?>superAdmin/assign-patient-single.php?id=<?= $user['id']?>" class="btn sm view"><i class="bi bi-pencil-square"></i>Assign Patient</a>
                   </td>
                  </tr>
