<?php 
  ...
  $query = "SELECT * FROM patient_assign ORDER BY pat_fname ASC";
  ...
  <main id="main" class="main">
   ...
   <?php elseif(isset($_SESSION['delete-user-success'])) :  // show if delete-user was successful ?>
    ...
    <?php
      ...
      $query = "SELECT * FROM patient_transfer ORDER BY pat_fname ASC";
      $users = mysqli_query($connection, $query);
      $cnt = 1;
    ?>
    ...
    // fetch users from database but not Super admin
  $admin_id = $_SESSION['user-id'];
  $query = "SELECT * FROM doc_transfer ORDER BY firstname ASC";
  $users = mysqli_query($connection, $query);
  $cnt = 1;
