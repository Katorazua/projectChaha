...
if (isset($_POST['submit'])) {
  ...
  if (!$phar_name){
      $_SESSION['add-user'] = "please enter phar_name";
  } elseif (!$phar_qty) {
      $_SESSION['add-user'] = "please enter phar_qty";
  } elseif (!$phar_bcode) {
      $_SESSION['add-user'] = "please enter phar_bcode";
  } elseif (!$phar_desc) {
      $_SESSION['add-user'] = "please enter phar_desc";
  } else {
