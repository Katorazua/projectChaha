...
if (isset($_POST['submit'])) {
    ...
    if (!$firstname){
        ...
        // update user
        $user_query = " UPDATE users SET firstname='$firstname', lastname = '$lastname', email = '$email', username = '$username', userfield = '$userfield', phone='$phone', role = '$user_role', gender = '$gender' WHERE id = $id LIMIT 1";  
          ...
          <form method="post" enctype="multipart/form-data" class="row g-3">
            ...
            <div class="col-md-6">
                ...
                <select name="role" id="inputState" class="form-select">
                    <option value="<?=$user['role']?>"><?=$user['role']?>(currently)</option>
