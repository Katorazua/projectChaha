...
if (isset($_POST['submit'])) {
  ...
  if (!$eqp_name){
      $_SESSION['add-user'] = "please enter eqp_name";
  } elseif (!$eqp_qty) {
      $_SESSION['add-user'] = "please enter eqp_qty";
  } elseif (!$eqp_code) {
      $_SESSION['add-user'] = "please enter eqp_code";
  } elseif (!$eqp_desc) {
      $_SESSION['add-user'] = "please enter eqp_desc";
  } else {
        ...
        <div class="card-body">
          ...
          <form method="post" enctype="multypat/form-data" class="row g-3">
            ...
            <div class="form-group col-md-6">
                ...
                ?>
                <input required="required" type="text" value="<?php echo $eqp_code;?>" name="eqp_code" class="form-control"  id="inputPassword4">
            </div>
