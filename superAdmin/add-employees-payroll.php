...
if (isset($_POST['submit'])) {
    // get signup form data if signup button was clicked
      ...
      $rid = filter_var($_POST['pay_emp_id'], FILTER_SANITIZE_FULL_SPECIAL_CHARS);
    ...
    if (!$pay_doc_name){
        $_SESSION['add-user'] = "please enter Employee's fullname";
        ...
        $_SESSION['add-user'] = "please enter Employee's salary";
    } elseif (!$pay_acc_number) {
        $_SESSION['add-user'] = "please enter Employee's Account Number";
    } elseif (!$pay_descr) {
       ...
       if (mysqli_num_rows($user_check_result) > 0) {
           $_SESSION['add-user'] = "Employee's number or Email already exist on payroll";
       }
    } 
  
    // redirect back to add-Employee payroll if there was any problem
    if (isset($_SESSION['add-user'])) {
      ...
      if (!mysqli_errno($connection)) {
          // redirect to manpassword-Employee ppassword with success messpassword
          $_SESSION['add-user-success'] = " $pay_doc_name, added to payroll successfully";
      }
    } 
  }
...
?>
  ...
  <main id="main" class="main">
    ...
    <section class="section">
      <div class="card">
        <div class="card-body">
          <h1 class="text-center card-title">Add Employees</h1>
          <hr>
            ...
            <form method="post" enctype="multipart/form-data" class="row g-3">
                <div class="row">
                    ...
                    <div class="form-group col-md-4">
                      <label for="inputEmail4" class="col-form-label">Employee's Name</label>
                      <input type="hidden" name="pay_emp_id" value="<?=$user['id']?>" class="form-control">
                    ...
                    <div class="form-group col-md-4">
                        <label for="inputPassword4" class="col-form-label">Employee's Email</label>
                    ...
                    <div class="form-group col-md-4">
                        <label for="inputPassword4" class="col-form-label">Employee's Number</label>
                        <input required="required" type="text" readonly name="pay_doc_number" value="<?= $user['emp_number']?>" class="form-control"  id="inputPassword4" placeholder="Patient`s Last Name">
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        <label for="inputEmail4" class="col-form-label">Employee's Salary ($/NGN)</label>
                        <input type="text" required="required"  name="pay_emp_salary" value="<?=$pay_emp_salary?>"  class="form-control" id="inputEmail4" >
                    </div>

                    <div class="form-group col-md-6">
                        <label for="inputEmail4" class="col-form-label">Employee's Account Number</label>
