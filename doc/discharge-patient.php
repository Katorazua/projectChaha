...
$user_query = "SELECT * FROM patients WHERE doc_id=$doc_id ORDER BY RAND()";
              ...
              <table class="table datatable">
                ...
                <?php while ($user = mysqli_fetch_assoc($user_result)) :?>
                  <tr>
                    ...
                    <td><?= $user['pat_discharge_status'] ?></td>
                    <td>
                      <a href="discharge-patient-single.php?id=<?= $user['id']?>" class="btn sm view"><i class="bi bi-pencil-square"></i>Discharge Patient</a>
                    </td>
                  </tr>
