...
if (!$lab_pat_name){
    ...
    if (isset($_SESSION['add-user'])) {
        ...
        $user_query = " INSERT INTO  laboratory (doc_id, lab_pat_name, lab_pat_number, lab_pat_age, lab_pat_gender, lab_pat_ailment, lab_pat_unit, lab_number, lab_pat_tests) VALUES('$admin_id', '$lab_pat_name', '$lab_pat_number', '$lab_pat_age', '$lab_pat_gender', '$lab_pat_ailment', '$lab_pat_unit', '$lab_number', '$lab_pat_tests')";
...
?>
  ...
  <!-- ======= Footer ======= -->
<?php include '../partials/dashbordfooter.php' ?>