...
$pat_ailment = filter_var($_POST['pat_ailment'], FILTER_SANITIZE_FULL_SPECIAL_CHARS);
    ...
    if(!$ref_hospital) {
      ...
      if (mysqli_num_rows($user_check_result) > 0) {
        ...
        $user_query = " INSERT INTO patient_transfer (doc_id, pat_fname, pat_lname, pat_email, pat_dob, pat_age, pat_addr, pat_gender, pat_number, pat_phone, pat_country, ref_hospital, pat_ailment, status) VALUES('$admin_id', '$firstname', '$lastname', '$email', '$dob', '$age', '$addr', '$gender', '$pat_number', '$phone','$city','$ref_hospital', '$pat_ailment', '$status')";
