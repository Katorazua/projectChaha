                ...
                <tbody>
                  <?php while ($post = mysqli_fetch_assoc($posts)) : ?>
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="view-single-product.php?id=<?= $post['id']?>" class="btn sm view"><i class="bi bi-eye"></i>View</a>
                        <!-- <a href="<?= ROOT_URL ?>cart/add-to-cart.php?id=<?= $post['id']?>" class="btn sm"><i class="bi bi-cart"></i>Add To Cart</a> -->
                     </td>
                    </tr>
