...
// $host = "localhost";
// $username = "alpha/project/chahahospital";
// $password = "chaha/admin/53550";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($result->num_rows > 0) {
        ...
        $sql = "UPDATE doctors SET reset_token_hash = ?, reset_token_expiration = ? WHERE id = ?";
        $stmt = $connection->prepare($sql);
        ...
        $message .= "http://localhost/projectChaha/doc/reset-password.php?token=" . $reset_token;
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="login_part_text text-center">
                        <div class="login_part_text_iner">
                            ...
                            <a href="doc-login.php" class="btn_3">continue with login</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6">
