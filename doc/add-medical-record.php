...
$user_query = "SELECT * FROM patients WHERE doc_id=$admin_id ORDER BY pat_fname ASC";
              ...
              <table class="table datatable">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><?= $user['pat_type'] ?></td>
                    <td>
                      <a href="add-single-patient-medical-record.php?id=<?= $user['id']?>" class="btn sm view"><i class="bi bi-pencil-square"></i>Add Medical Record</a>
                    </td>
                  </tr>
              ...
              <table class="table datatable">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><?= $row['doc_dept'] ?></td>
                    <td>
                      <a href="add-asigned-patient-medical-record.php?id=<?= $row['id']?>" class="btn sm view"><i class="bi bi-pencil-square"></i>Add Medical Record</a>
                    </td>
                  </tr>
                  <?php $cnt=$cnt+1; endwhile ?>
                  </tbody>
