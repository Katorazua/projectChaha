  ...
  <main class="main">
    ...
    <section id="hero" class="hero section">
      ...
      <div id="hero-carousel" class="carousel slide carousel-fade" data-bs-ride="carousel" data-bs-interval="5000">
        ...
        <div class="carousel-item active">
          <img src="assets/img/chaha-eye-hospital.jpg" alt="">
          <div class="container">
            <h2>Welcome to Chah Eye Hospital</h2>
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
            <a href="<?=ROOT_URL?>events.php" class="btn-get-started">Read More</a>
            <a href="<?=ROOT_URL?>pricing.php" class="btn-get-started">Get Started</a>
          </div>
        ...
        <div class="carousel-item">
          ...
          <div class="container">
            <h2>Your eyes are the windows to your soul!</h2>
        ...
        <div class="carousel-item">
          ...
          <div class="container">
            <h2>Keep Your Future Healthy</h2>
        ...
        <div class="row gy-4">
          ...
          <div class="col-xl-3 col-md-6 d-flex" data-aos="fade-up" data-aos-delay="100">
            <div class="service-item position-relative">
              ...
              <h4><a href="" class="stretched-link">Do You Know?</a></h4>
      ...
      <div class="container">
        ...
        <div class="row justify-content-around gy-4">
          ...
          <div class="col-lg-5 d-flex flex-column justify-content-center" data-aos="fade-up" data-aos-delay="200">
            <h3>The World's Best Eye Hospital That You Can Trust</h3>
            <p>We Are A Certified and Award Winning Eye Hospital You Can Trust. We Offer Fair Prices for Treatment</p>
    ...
    <section id="doctors" class="doctors section light-background">
      <?php
        ...
        $query = "SELECT * FROM doctors ORDER BY RAND() LIMIT 4 ";
        $result = mysqli_query($connection, $query);
      ?>
      <!-- Section Title -->
      <div class="container section-title" data-aos="fade-up">
        <h2>Doctors</h2>
        <p>Meet Our Certified & Experienced Doctors</p>
      </div><!-- End Section Title -->
            ...
            <div class="col-lg-3 col-md-6 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="100">
              <div class="team-member">
                <div class="member-img">
                  <img src="./images/<?= $user['avatar']?>" class="img-fluid" alt="Picture">
                  <div class="social">
                    <a target="_blank" href="<?=$user['twitter'] ?>"><i class="bi bi-twitter-x"></i></a>
                    <a target="_blank" href="<?=$user['facebook'] ?>"><i class="bi bi-facebook"></i></a>
                    <a target="_blank" href="<?=$user['instagram'] ?>"><i class="bi bi-instagram"></i></a>
                    <a target="_blank" href="<?=$user['linkedin'] ?>"><i class="bi bi-linkedin"></i></a>
                  </div>
                </div>
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="swiper init-swiper">
          ...
          <div class="swiper-wrapper align-items-center">
            ...
            <div class="swiper-slide"><a class="glightbox" data-gallery="images-gallery" href="assets/img/treatment-1.jpg"><img src="assets/img/gallery/gallery-2.jpg" class="img-fluid" alt=""></a></div>
            <div class="swiper-slide"><a class="glightbox" data-gallery="images-gallery" href="assets/img/gallery/gallery-3.jpg"><img src="assets/img/gallery/gallery-3.jpg" class="img-fluid" alt=""></a></div>
            <div class="swiper-slide"><a class="glightbox" data-gallery="images-gallery" href="assets/img/treatment-3.jpg"><img src="assets/img/gallery/gallery-4.jpg" class="img-fluid" alt=""></a></div>
            <div class="swiper-slide"><a class="glightbox" data-gallery="images-gallery" href="assets/img/gallery/gallery-5.jpg"><img src="assets/img/gallery/gallery-5.jpg" class="img-fluid" alt=""></a></div>
            <div class="swiper-slide"><a class="glightbox" data-gallery="images-gallery" href="assets/img/treatment-2.jpg"><img src="assets/img/gallery/gallery-6.jpg" class="img-fluid" alt=""></a></div>
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="row gy-4">
            ...
            <div class="row gy-4">
              ...
              <div class="col-lg-12">
                <div class="info-item d-flex flex-column justify-content-center align-items-center" data-aos="fade-up" data-aos-delay="200">
                  ...
                  <h3>Address</h3>
                  <p>A247 Alpha Street, AlphaRes Nigeria, ANY 535022</p>
                </div>
              </div><!-- End Info Item -->
          ...
          <div class="col-lg-6">
            ...
            <?php endif ?>
            <form action="<?=ROOT_URL?>support.php" method="post" class="php-email-form" data-aos="fade-up" data-aos-delay="500" enctype="multipart/form-data">
              <div class="row gy-4">
                ...
                <div class="col-md-6">
                  <input type="text" class="form-control" name="amount" placeholder="Amount of choise" required="">
                </div>
                ...
                <div class="col-md-6" style="display: none;">
                  ...
                  ?>
                  <input type="text" class="form-control" name="ref_pin" value="<?=$ref_pin?>" placeholder="Transaction reference" required="">
                </div>

                <div class="col-md-12">
                  <textarea class="form-control" name="comment" rows="4" placeholder="Message" required=""></textarea>
                </div>
