              ...
              <table class="table datatable">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><?= $user['status'] ?></td>
                    <td>
                      <a href="<?= ROOT_URL ?>superAdmin/doctors-profile.php?id=<?= $user['id']?>" class="btn sm view"><i class="bi bi-eye"></i></a>
                      <a href="<?= ROOT_URL ?>superAdmin/edit-doctor.php?id=<?= $user['id']?>" class="btn sm"><i class="bi bi-pencil-square"></i></a>
                      <a href="<?= ROOT_URL ?>superAdmin/delete-doctor.php?id=<?= $user['id']?>" class="btn sm danger"><i class="bi bi-trash"></i></a>
                    </td>
                  </tr>
