...
?>
  ...
  <main id="main" class="main">
    ...
    <?php 
      ...
      $users_post = "SELECT * FROM products ORDER BY RAND()";
                ...
                <tbody>
                  <?php while ($post = mysqli_fetch_assoc($posts)) : ?>
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="<?= ROOT_URL ?>superAdmin/view-product.php?id=<?= $post['id']?>" class="btn sm view"><i class="bi bi-eye"></i></a>
                        <a href="<?= ROOT_URL ?>superAdmin/edit-product.php?id=<?= $post['id']?>" class="btn sm"><i class="bi bi-pencil-square"></i></a>
                        <a href="<?= ROOT_URL ?>superAdmin/delete-product.php?id=<?= $post['id']?>" class="btn sm danger"><i class="bi bi-trash"></i></a>
                      </td>
                    </tr>
