...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 22, 2024 at 04:46 PM
...
INSERT INTO `patients` (`id`, `admin_id`, `doc_id`, `pat_fname`, `pat_lname`, `pat_dob`, `pat_age`, `pat_number`, `pat_email`, `pat_gender`, `pat_addr`, `pat_phone`, `pat_type`, `pat_ailment`, `pat_country`, `pat_reg_date`, `pat_discharge_status`, `hps`) VALUES
(1, 4, NULL, 'John', 'Doe', '2020-01-03', '4', 'CEH123', 'johndoe@gmail.com', 'Female', 'Opp. Nigeria Brewery KM5 Gboko Road', '8923475609', 'In-patient', 'Eye defect', 'Makurdi, Benue State, Nigeria', '2024-03-18 23:28:06.999704', 'NULL', NULL),
(2, 4, NULL, 'Jane', 'Jodan', '2024-03-27', '32', 'CEH124', 'jane@gmail.com', 'Female', 'Y2001 Alpha-Rest AV2, Nigeria.', '8923475609', 'In-patient', 'Eye defect', 'Makurdi, Benue State, Nigeria', '2024-03-22 15:39:27.038404', 'Discharged', NULL),
(3, 4, NULL, 'Jane', 'Banks', '2024-03-04', '14', 'CEH125', 'jb@gmail.com', 'Female', 'Y2001 Alpha-Rest AV2, Nigeria.', '8923475609', 'Out-pateint', 'ailment demo', 'Makurdi, Benue State, Nigeria', '2024-03-22 15:38:58.072068', 'On-Medication', NULL),
(5, NULL, 4, 'Jay', 'Cool', '2024-03-25', '24', 'CEH126', 'jaycool@gmail.com', 'Male', 'Y2001 Alpha-Rest AV2, Nigeria.', '0987365729', 'Out-pateint', 'ailment demo2', 'Makurdi, Benue State, Nigeria', '2024-03-22 16:21:02.449218', NULL, NULL),
(6, NULL, 4, 'James ', 'Nater', '2024-03-11', '22', 'CEH127', 'james@gmail.com', 'Male', 'Opp. Nigeria Brewery KM5 Gboko Road', '89234756087', 'In-patient', 'ailment demo3', 'Makurdi, Benue State, Nigeria', '2024-03-22 17:31:47.523653', NULL, NULL),
(7, NULL, 6, 'Terna', 'Tor', '2024-04-30', '30', 'AHMS123', 'terna@gmail.com', 'Male', 'NG01 Alpharest, 0001AV2', '09047948447', 'Out-pateint', 'Demo Ailment', 'Nigeria', '2024-04-20 01:28:09.009931', 'Discharged', '2'),
(8, NULL, 6, 'James', 'Tar', '2024-04-30', '32', 'AHMS124', 'james@gmail.com', 'Male', 'NG01 Alpharest, 0001AV2', '09048948009', 'In-patient', 'Demo Ailment', 'Makurdi, Benue Nigeria.', '2024-04-20 01:28:23.263191', 'NULL', '2'),
(9, NULL, NULL, 'Ikpa', 'Senege', '2024-04-14', '18', 'AHMS125', 'senegeikpa@gmil.com', 'Female', 'NG01 Alpharest, 0001AV2', '09047948047', 'In-patient', 'Demo Ailment', 'Makurdi, Benue Nigeria.', '2024-04-20 01:52:09.564896', NULL, NULL),
(10, NULL, 7, 'James ', 'Torkwase', '2024-06-18', '32', 'CEH1234', 'james@gmail.com', 'Female', 'Opp. Nigeria Brewery KM5 Gboko Road', '8923475609', 'In-patient', 'Eye defect', 'Makurdi, Benue State, Nigeria', '2024-06-20 18:12:25.918882', NULL, NULL);
...
(4, 4, NULL, 'Jane', 'Jodan', '2024-03-27', 'jane@gmail.com', '32', 'Female', '8923475609', 'Makurdi, Benue State, Nigeria', 'CEH124', 'Y2001 Alpha-Rest AV2, Nigeria.', 'Eye defect', 'Hospital', 'Transfered', '2024-07-04 15:09:59.256009');
...
(1, NULL, 'Alpha', 'Manager', 'alphaMyAdmin', 'Male', 'projectalpha@email.com', '09047948009', 'AV002 AlphaRest, JPAVN.', 'Nigeria', '$2y$10$E4dSV08blNqZZNQujX0gTOltJSBsbbCzzbuxQYWvUEQ4ggVymonOy', '1711158415Alpha-favicon.png', 'Admin|Manager', 'Active now', 'I accept', NULL, 'expired', 'Bronze', NULL, NULL),
(4, NULL, 'Azua', 'kator', 'Dr. Kay', 'Male', 'katorazua674@gmail.com', '09047948009', 'AlphaRest, Y2 NG', 'Makurdi, Benue State, Nigeria', '$2y$10$7432xA1dFuFuTxCUaqT44e/eGmiH/OIISgfxS7ceke/qGqpHnESHK', '1719014031katorazua (1).jpg', 'Web Developer', 'Offline', 'I accept', NULL, 'expired', 'Bronze', NULL, NULL),
(33, NULL, 'James ', 'SI', 'james', 'Male', 'james@gmail.com', '0987365720', NULL, NULL, '$2y$10$widuAZd9u5/sx1oFFFuRY.vNuTiADe8M3V2Vjn0g/ea0G7PkjY0oS', '1716537225user.jpg', 'Cybersecurity', 'Offline', 'I accept', NULL, 'expired', 'Bronze', NULL, NULL),
(34, NULL, 'Adeke', 'Susan', 'Suzzy', 'Female', 'adekesuzzy@gmail.com', '0987365729', 'AlphaRest, Y2 NG', 'Nigeria', '$2y$10$.kUIFekkcFuDuoBZ6cArh.l6vrVw8ETEtQ/iBXITsGp8CZ8aWMppK', '1716538370testimonials-3.jpg', 'Developer', 'Offline', 'I accept', '2024-07-22 13:21:21', 'expired', 'Bronze', NULL, NULL),
(35, NULL, 'King', 'Susan', 'susan', 'Female', 'susan@gmail.com', '8923475609', NULL, NULL, '$2y$10$Em2vYsVQWYB4q/lifY2bIeOwovip/ZFDi4VtC8t3aHiNB2R4rwpmm', '1716538739testimonials-2.jpg', 'Gynocologist', 'Offline', 'I accept', NULL, 'expired', 'Bronze', NULL, NULL),
(37, NULL, 'Utsu', 'Gbihi', 'Leni', 'Male', 'line@gmail.com', '0987365729', NULL, NULL, '$2y$10$/D7Q8udSvnAQltENLkqHoulFBjZQZe96ZMRNwmfNsPtmHKbaoAhlq', '1717344138user.jpg', 'Developer', NULL, 'I accept', NULL, 'expired', 'Bronze', NULL, NULL);
...
--
-- AUTO_INCREMENT for table `doc_transfer`
--
ALTER TABLE `doc_transfer`
...
--
-- AUTO_INCREMENT for table `patient_assign`
--
ALTER TABLE `patient_assign`
...
--
ALTER TABLE `users`
  MODIFY `id` bigint(255) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=38;
...
--
ALTER TABLE `categories`
  ADD CONSTRAINT `FK_projectchaha_cat_admin` FOREIGN KEY (`admin_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION;

--
-- Constraints for table `department`
--
ALTER TABLE `department`
  ADD CONSTRAINT `FK_projectchaha_dept_admin` FOREIGN KEY (`admin_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION;

--
-- Constraints for table `doctors`
--
ALTER TABLE `doctors`
  ADD CONSTRAINT `FK_projectchaha_admin_id` FOREIGN KEY (`admin_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION;

--
-- Constraints for table `doc_transfer`
--
ALTER TABLE `doc_transfer`
  ADD CONSTRAINT `FK_chaha_admin_id` FOREIGN KEY (`admin_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION;

--
-- Constraints for table `employees`
--
ALTER TABLE `employees`
  ADD CONSTRAINT `FK_projectchaha_employee_admin_id` FOREIGN KEY (`admin_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION;

--
-- Constraints for table `employee_transfer`
--
ALTER TABLE `employee_transfer`
  ADD CONSTRAINT `FK_projectchaha_emp_admin_id` FOREIGN KEY (`admin_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION;

--
-- Constraints for table `events`
--
ALTER TABLE `events`
  ADD CONSTRAINT `FK_projectchaha_admin` FOREIGN KEY (`author_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION,
  ADD CONSTRAINT `FK_projectchaha_category` FOREIGN KEY (`category_id`) REFERENCES `categories` (`id`) ON DELETE SET NULL ON UPDATE NO ACTION;

--
-- Constraints for table `laboratory`
--
ALTER TABLE `laboratory`
  ADD CONSTRAINT `FK_projectchaha_lab_admin` FOREIGN KEY (`admin_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION,
  ADD CONSTRAINT `FK_projectchaha_lab_doc_id` FOREIGN KEY (`doc_id`) REFERENCES `doctors` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION;

--
-- Constraints for table `medical_records`
--
ALTER TABLE `medical_records`
  ADD CONSTRAINT `FK_projectchaha_mdr_admin` FOREIGN KEY (`admin_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION,
  ADD CONSTRAINT `FK_projectchaha_mdr_docID` FOREIGN KEY (`doc_id`) REFERENCES `doctors` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION;

--
-- Constraints for table `patient_assign`
--
ALTER TABLE `patient_assign`
  ADD CONSTRAINT `FK_projectchaha_admin_number` FOREIGN KEY (`doc_number`) REFERENCES `doctors` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION;
COMMIT;
