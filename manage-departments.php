              ...
              <table class="table datatable">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><a href="<?= ROOT_URL ?>superAdmin/edit-department.php?id=<?= $category['id']?>" class="btn sm"><i class="bi bi-pencil-square"></i></a>
                    <a href="<?= ROOT_URL ?>superAdmin/delete-department.php?id=<?= $category['id']?>" class="btn sm danger"><i class="bi bi-trash"></i></a></td>
                  </tr>
