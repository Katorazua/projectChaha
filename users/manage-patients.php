...
$user_query = "SELECT * FROM patients WHERE admin_id=$admin_id";
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h1 class="text-center card-title">My Form</h1>
              <hr>
              ...
              <table class="table datatable">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><?= $user['pat_type'] ?></td>
                    <td>
                      <a href="edit-patient.php?id=<?= $user['id']?>" class="btn sm"><i class="bi bi-pencil-square"></i>Update</a>
                      <a href="delete-patient.php?id=<?= $user['id']?>" class="btn sm danger"><i class="bi bi-trash"></i>Delete</a>
                    </td>
                  </tr>
