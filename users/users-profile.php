            ...
            <div class="card-body pt-3">
              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                  ...
                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">My Plan</div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <select name="status" id="fullName" class="form-select">
                          <option value="<?=$user['user_mode']?>"><?=$user['user_mode']?> (Corrently)</option>
                          <option value="Offline">Offline</option>
                          <option value="Busy,can't talk now">Busy, can't talk </option>
                          <option value="At work">At work</option>
                          <option value="In Travels">In Travels</option>
