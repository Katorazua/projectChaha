...
if (isset($_POST['submit'])) {
  ...
  // redirect back to add-user page if there was any problem
    if (isset($_SESSION['add-user'])) {
        ...
        $user_query = " INSERT INTO users (admin_id, firstname, lastname, email, username, gender, phone, userfield, password, avatar, role, terms) VALUES('$admin_id', '$firstname', '$lastname', '$email', '$username', '$gender', '$phone', '$userfield', '$hashed_password', '$avatar_name', '$user_role','$terms')";
...
?>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>My Family &amp; Friends MIS</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="manage-members.php">Home</a></li>
          <li class="breadcrumb-item">Add Any Member Of Choise.</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    <section class="section">
      <div class="card">
        <div class="card-body">
          <h1 class="text-center card-title"> Add A Member </h1>
          <hr>
          ...
          <form method="post" enctype="multipart/form-data" class="row g-3">
            ...
            <div class="col-md-6 form-group p_star">
                ...
                <input type="text" class="form-control" name="userfield" value="<?=$userfield?>"
                    placeholder="job (occupation)" required>
            </div>
            <div class="col-md-6 form-group p_star">
